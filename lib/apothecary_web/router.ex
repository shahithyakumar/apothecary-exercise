defmodule ApothecaryWeb.Router do
  use ApothecaryWeb, :router

  import ApothecaryWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ApothecaryWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: ApothecaryWeb.Telemetry
    end
  end
